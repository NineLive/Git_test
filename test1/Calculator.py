...
make_digit_button('1').grid(row=3, column=0, sticky='news')
make_digit_button('2').grid(row=3, column=1, sticky='news')
make_digit_button('3').grid(row=3, column=2, sticky='news')
make_digit_button('4').grid(row=2, column=0, sticky='news')
make_digit_button('5').grid(row=2, column=1, sticky='news')
make_digit_button('6').grid(row=2, column=2, sticky='news')
make_digit_button('7').grid(row=1, column=0, sticky='news')
make_digit_button('8').grid(row=1, column=1, sticky='news')
make_digit_button('9').grid(row=1, column=2, sticky='news')
make_digit_button('0').grid(row=4, column=1, sticky='news')
make_operation_button('+').grid(row=1, column=3, sticky='news')
make_operation_button('-').grid(row=2, column=3, sticky='news')
make_operation_button('*').grid(row=3, column=3, sticky='news')
make_operation_button('/').grid(row=4, column=3, sticky='news')
make_negative_button('+/-').grid(row=4, column=0, sticky='news')
make_calc_button('=').grid(row=4, column=2, sticky='news')
